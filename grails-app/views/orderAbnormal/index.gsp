...
<script type="text/javascript">
    ...
    Ext.onReady(function () {
        ...
        var abnormalResions = [];
        <g:each in="${params?.abnormalResions}">
        abnormalResions.push([${it.id}, '${it.paramValue}']);
        </g:each>
        //数据字段
        var dataFields = [
            'id',
            ...
            buttons: [
                {
                    ...
                    handler: function () {
                        ...
                        if (count < 1) {
                            ...
                            Ext.MessageBox.confirm('操作', "有【" + count + "】条记录将异常终结，确认请交？", function (btn) {
                                if (btn == "yes") {
                                    var reson = Ext.getCmp('abnormalReson')
                                    var remarks = ''
                                    ...
                                    Ext.Ajax.request({
                                        ...
                                        success: function (r) {
                                            ...
                                            if (result.success) {
                                                Ext.MessageBox.show({title: '提示:', msg: "提交成功!", width: 300, buttons: Ext.MessageBox.OK, icon: Ext.MessageBox.INFO});
