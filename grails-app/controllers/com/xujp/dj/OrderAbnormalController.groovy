...
class OrderAbnormalController {
    ...
    def index() {
        ...
        def abnormalResions = SystemParam.findAllByGroup(SystemParamGroup.findByGroupName('异常终结原因'))
        params.abnormalResions = abnormalResions
    }
    ...
    def saveFinishd = {
        ...
        try {
            ...
            orderService.orderAbnormal( params.ids,params.reason,params.remark)
            ...
            jsonData = new JSONData(success: false, alertMsg: "保存异常终结失败,请重试!", soundMsg: '错误')
            render jsonData as JSON
            return
        }
    }
